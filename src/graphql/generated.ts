...
export type LessonCreateInput = {
  ...
  challenge?: InputMaybe<LessonCreateOneInlineInput>;
  cl8b0zced0afs01ui57xhfjf7?: InputMaybe<LessonCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
...
export type LessonManyWhereInput = {
  ...
  challenge?: InputMaybe<LessonWhereInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  createdAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type LessonUpdateInput = {
  avaliableAt?: InputMaybe<Scalars['DateTime']>;
  challenge?: InputMaybe<LessonUpdateOneInlineInput>;
  cl8b0zced0afs01ui57xhfjf7?: InputMaybe<LessonUpdateManyInlineInput>;
  description?: InputMaybe<Scalars['String']>;
  lessonType?: InputMaybe<LessonType>;
  slug?: InputMaybe<Scalars['String']>;
...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, avaliableAt?: any | null, title: string, slug: string }> };

export type GetSlugWithoutLinkQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSlugWithoutLinkQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', slug: string }> };
...
export const GetSlugWithoutLinkDocument = gql`
    query GetSlugWithoutLink {
  lessons(first: 1) {
    slug
  }
}
...
/**
 * __useGetSlugWithoutLinkQuery__
 *
 * To run a query within a React component, call `useGetSlugWithoutLinkQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetSlugWithoutLinkQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetSlugWithoutLinkQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetSlugWithoutLinkQuery(baseOptions?: Apollo.QueryHookOptions<GetSlugWithoutLinkQuery, GetSlugWithoutLinkQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSlugWithoutLinkQuery, GetSlugWithoutLinkQueryVariables>(GetSlugWithoutLinkDocument, options);
      }
export function useGetSlugWithoutLinkLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSlugWithoutLinkQuery, GetSlugWithoutLinkQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSlugWithoutLinkQuery, GetSlugWithoutLinkQueryVariables>(GetSlugWithoutLinkDocument, options);
        }
export type GetSlugWithoutLinkQueryHookResult = ReturnType<typeof useGetSlugWithoutLinkQuery>;
export type GetSlugWithoutLinkLazyQueryHookResult = ReturnType<typeof useGetSlugWithoutLinkLazyQuery>;
export type GetSlugWithoutLinkQueryResult = Apollo.QueryResult<GetSlugWithoutLinkQuery, GetSlugWithoutLinkQueryVariables>;